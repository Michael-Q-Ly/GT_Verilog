...
#include <stdio.h>
#include <stdlib.h>
#include "VledWalker2.h"
#include "verilated.h"
#include "verilated_vcd_c.h"

int const NUM_LEDS = 16 ;

void tick( int tick_count, VledWalker2 *tb, VerilatedVcdC *tfp ) ;
...
int main( int argc, char**argv ) {
	...
	VledWalker2 *tb = new VledWalker2 ;
	// Generate a trace
	Verilated::traceEverOn( true ) ;
	VerilatedVcdC *tfp = new VerilatedVcdC ;
	tb -> trace( tfp, 99 ) ;
	tfp -> open( "ledWalker2.vcd" ) ;
